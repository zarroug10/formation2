...
public class TokenService(IConfiguration config) : ITokenService // class that uses the interface of the configuration using dependedncy injection and the inherentce to use the interface 
// of the token interface
{
    public string CreateToken(AppUser user) //the methode inherted from the token interface 
    {
